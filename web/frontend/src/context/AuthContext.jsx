...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (username, password) => {
    try {
      ...
      // Fetch the full user record (role, is_active, ...) rather than just
      // the username — needed immediately for role-gated UI (e.g. the Admin
      // nav link) without requiring a page reload first.
